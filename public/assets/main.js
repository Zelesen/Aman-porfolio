const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "./src-OUKUEtN6.js",
      "./vendor-ogl-vHIDfeo9.js",
      "./gsap-C_F2famk.js",
      "./vendor-gsap-dtbWDTxQ.js",
      "./ScrollTrigger-C0K7cnyT.js",
      "./splitting-oi4GEGE6.js",
      "./vendor-splitting-C_XI8yvf.js",
      "./rolldown-runtime-ciTZEWaI.js",
      "./lenis-CfxVH_NU.js",
      "./vendor-lenis-Cm0LW3lU.js",
    ]),
) => i.map((i) => d[i]);
import { n as e } from "./rolldown-runtime-ciTZEWaI.js";
import { t } from "./preload-helper-Dbp7xEFQ.js";
((() => {
  let e = document.getElementById(`preloader`);
  if (!e) return;
  let t = e.querySelector(`.preloader-canvas`),
    n = e.querySelector(`.preloader-pct .num`),
    r = e.querySelector(`.preloader-bar`),
    i = matchMedia(`(prefers-reduced-motion: reduce)`).matches,
    a = document.documentElement.dataset.tier || `high`,
    o = a === `low` ? 0 : a === `mid` ? 12 : 20,
    s = a === `low` ? 1 : a === `mid` ? 1.5 : 2;
  e.dataset.fontReady = `false`;
  let c =
    document.fonts && document.fonts.load
      ? document.fonts.load(`800 100px "Harmond"`).catch(() => {})
      : Promise.resolve();
  Promise.race([c, new Promise((e) => setTimeout(e, 500))]).then(() => {
    e.dataset.fontReady = `true`;
  });
  let l = 0,
    u = [],
    d = !1,
    ...
    p = [],
    m = Array.from(
      document.querySelectorAll(`link[rel="preload"][as="image"], img[src]`),
    ),
    h = [],
    g = new Set();
  for (let e of m) {
    let t = e.href || e.src;
    !t || g.has(t) || (g.add(t), h.push(t));
  }
  let _ = document.fonts ? document.fonts.ready : Promise.resolve(),
    v = h.length + 2,
    y = 0,
    b = 0,
    x = 0,
    ...
    C = 0,
    w = () => {
      ((y = Math.min(v, y + 1)), (x = y / v));
    };
  (h.forEach((e) => {
    let t = new Image();
    ((t.onload = w), (t.onerror = w), (t.src = e));
  }),
    _.then(w).catch(w));
  let T = !1,
    E = () => {
  ...
  window.__heroShader && window.__heroShader.ready
    ? E()
    : (window.addEventListener(`hero-shader:ready`, E, { once: !0 }),
      setTimeout(E, 2500));
  let D = 0;
  try {
    typeof PerformanceObserver < `u` &&
      new PerformanceObserver((e) => {
        ((D += e.getEntries().length), (S = Math.min(0.9, D / 40)));
      }).observe({ type: `resource`, buffered: !0 });
  } catch {}
  let O = a === `low` ? 400 : a === `mid` ? 800 : 1200,
    k = a === `low` ? 900 : a === `mid` ? 1600 : 2400,
    A = performance.now(),
    j = 0,
    M = 0.2;
  function N() {
    let e = performance.now() - A,
      t = Math.min(M, (e / 400) * M),
      n = Math.min(0.85, e / O),
      r = Math.max(x, S, n) * (1 - M),
      i = Math.min(y >= v ? 1 : 0.95, t + r);
    ((C = Math.min(i, j + 0.02)), (j = C));
  }
  let P = setTimeout(() => {
    ((y = v), (x = 1), (S = 1));
  }, k);
  function F() {
    let e = Math.round(b * 100);
    (n && (n.textContent = String(e).padStart(3, `0`)),
      r && r.style.setProperty(`--progress`, b.toFixed(4)));
  }
  if (i) {
    ((t.style.display = `none`),
      (function e() {
        if ((N(), (b += (C - b) * 0.12), F(), b >= 0.995 && C >= 0.999)) {
          re();
          return;
        }
  ...
  function z(e) {
    return R(`data:image/svg+xml;charset=utf-8,` + encodeURIComponent(e));
  }
  async function B() {
    let e = [];
    for (let t = 0; t < 3; t++) {
      let n = await R(I[t]);
      ((n ||= await z(L[t])), n && e.push(n));
    }
    return e;
  }
  f = t.getContext(`2d`);
  let V = Math.min(window.devicePixelRatio || 1, s);
  a !== `high` && f && (f.imageSmoothingQuality = `low`);
  let H = 0,
    U = 0;
  function W() {
    ((H = window.innerWidth),
      (U = window.innerHeight),
      (t.width = Math.floor(H * V)),
  ...
  function K(e, t = !1) {
    ...
    return {
      img: e[Math.floor(Math.random() * e.length)],
      x: Math.random() * H,
      y: t ? -40 - Math.random() * U * 0.6 : Math.random() * U,
      z: n,
      scale: 0.16 + n * 0.72,
      rot: Math.random() * Math.PI * 2,
      rotV: (Math.random() - 0.5) * 0.028,
      vy: 0.25 + n * 1.3 + Math.random() * 0.45,
  ...
  function q(e) {
    for (let t = 0; t < G; t++) p.push(K(e, !1));
  }
  let J = { x: -9999, y: -9999, prevX: 0, prevY: 0, vx: 0, vy: 0, active: !1 };
  function Y(e) {
    let n = t.getBoundingClientRect(),
      r = e.clientX - n.left,
      i = e.clientY - n.top;
    (J.active && ((J.vx = r - J.prevX), (J.vy = i - J.prevY)),
      (J.prevX = r),
      (J.prevY = i),
      (J.x = r),
      (J.y = i),
  ...
  function X() {
    ((J.active = !1), (J.x = -9999), (J.y = -9999), (J.vx = 0), (J.vy = 0));
  }
  (e.addEventListener(`pointermove`, Y, { passive: !0 }),
    e.addEventListener(`pointerdown`, Y, { passive: !0 }),
    e.addEventListener(`pointerleave`, X, { passive: !0 }));
  let Z = performance.now(),
    ee = 0,
    te = !1;
  function ne() {
    let e = (performance.now() - Z) / 1e3;
    (N(),
      (b += (C - b) * 0.08),
      te && (f.setTransform(V, 0, 0, V, 0, 0), f.clearRect(0, 0, H, U)));
    let t = 0.25 + Math.sin(e * 0.35) * 0.5,
      n = Math.hypot(J.vx, J.vy);
    if (te)
      for (let r = 0; r < p.length; r++) {
        let i = p[r],
          a = Math.sin(e * 0.6 + i.phase) * i.drift;
        if (
          ((i.x += i.vx + a * 0.35 + t * 0.25 * i.z),
          (i.y += i.vy),
          (i.rot += i.rotV + t * 0.002),
          (i.x += i.gx),
          (i.y += i.gy),
          (i.gx *= 0.92),
          (i.gy *= 0.92),
          Math.abs(i.gx) < 0.02 && (i.gx = 0),
          Math.abs(i.gy) < 0.02 && (i.gy = 0),
          J.active && n > 0.5)
        ) {
          let e = i.x - J.x,
            t = i.y - J.y,
          ...
          if (r < 32400 && r > 1) {
            let a = Math.sqrt(r),
              o = 1 - a / 180,
              s = Math.min(18, n * 0.25) * o;
            ((i.gx += (e / a) * s * 0.6),
              (i.gy += (t / a) * s * 0.3 + s * 0.15),
              (i.rotV += (Math.random() - 0.5) * 0.006 * o));
          }
        }
        (i.y > U + 60 &&
          ((i.y = -50),
          (i.x = Math.random() * H),
          (i.rot = Math.random() * Math.PI * 2)),
          i.x < -80 ? (i.x = H + 80) : i.x > H + 80 && (i.x = -80));
        let o = i.img;
        if (!o) continue;
        (f.save(),
          (f.globalAlpha = i.alpha * (0.55 + b * 0.45)),
          f.translate(i.x, i.y),
          f.rotate(i.rot));
        let s = 0.85 + Math.abs(Math.sin(e * 0.8 + i.phase)) * 0.15;
        (f.scale(i.scale, i.scale * s),
          f.drawImage(o, -o.width / 2, -o.height / 2),
          f.restore());
      }
    if (
      (F(),
      b >= 0.995 &&
        C >= 0.999 &&
        ((ee ||= performance.now()), performance.now() - ee > 200))
    ) {
      re();
      return;
    }
    ...
    ((t.style.display = `none`),
      (function e() {
        let t = performance.now() - A,
          n = Math.min(M, (t / 400) * M),
          r = Math.min(0.85, t / O),
          i = Math.max(x, S, r) * (1 - M);
        if (
          ((C = Math.min(y >= v ? 1 : 0.95, n + i)),
          (b += (C - b) * 0.3),
          F(),
          b >= 0.995 && C >= 0.999)
        ) {
    ...
    B().then((n) => {
      if (!d) {
        ...
        ((u = n),
          q(n),
          (te = !0),
          requestAnimationFrame(() => e.classList.add(`is-canvas-ready`)));
      }
    }));
  function re() {
    if (d) return;
    ...
    ((d = !0), (l &&= (cancelAnimationFrame(l), 0)));
    let r = e.querySelector(`.preloader-ui`);
    (r && ((r.style.transition = `none`), (r.style.opacity = `0`)),
      clearTimeout(P));
    try {
      (e.removeEventListener(`pointermove`, Y),
        e.removeEventListener(`pointerdown`, Y),
        e.removeEventListener(`pointerleave`, X),
    ...
    (e.classList.add(`is-done`),
      ...
      setTimeout(() => {
        ...
        for (let e = 0; e < p.length; e++) p[e].img = null;
        ((p.length = 0), (u.length = 0), e.remove());
      }, 650));
  }
})(),
  (() => {
    ...
    function s(c) {
      ...
      ((r[i] = l), (i = (i + 1) % 60), a < 60 && a++);
      let u = 0;
      for (let e = 0; e < a; e++) u += r[e];
      let d = a > 0 ? (1e3 * a) / u : 0;
      for (
        t.push({ t: c, fps: d }), n.push({ t: c, dt: l });
        t.length > 0 && c - t[0].t > e;
      )
        t.shift();
      for (; n.length > 0 && c - n[0].t > e; ) n.shift();
      (p(d), requestAnimationFrame(s));
    }
    let c = [];
        ...
        new PerformanceObserver((e) => {
          for (let t of e.getEntries())
            (c.push({
              ...
              l.push({ type: `longtask-${t.duration | 0}ms`, t: t.startTime }),
              m());
        }).observe({ entryTypes: [`longtask`] });
      } catch {}
    let l = [];
    function u(e, n = {}) {
      let r = { type: e, t: performance.now(), ...n };
      (l.push(r),
        m(),
        setTimeout(() => {
          ((r.fpsWindow = t
            .filter((e) => e.t >= r.t - 500 && e.t <= r.t + 1500)
            .map((e) => ({
              dt: Math.round(e.t - r.t),
    ...
    ((d.id = `perf-overlay`),
      (d.style.cssText = [
        ...
        `color:#fff`,
        `font:11px/1.4 ui-monospace,"JetBrains Mono",Consolas,monospace`,
        `padding:8px 10px`,
        `border-radius:6px`,
  ...
  `));
    ...
    function p(e) {
      let n = f(`po-fps`);
      if (!n) return;
      ((n.textContent = `${e.toFixed(0)} fps`),
        (n.style.color = e < 50 ? `#ff5a5a` : e < 90 ? `#ffa64d` : `#7ee8c4`));
      let r = t.slice(-300);
      if (r.length > 10) {
        let e = r.map((e) => e.fps).sort((e, t) => e - t),
          t = (t) => Math.round(e[Math.floor(e.length * t)] || 0),
          n = f(`po-sum`);
        n &&
          (n.textContent = `min ${t(0)} · p10 ${t(0.1)} · med ${t(0.5)} · p90 ${t(0.9)} · max ${t(0.99)}`);
      }
    }
    function m() {
      let e = f(`po-log`);
      e &&
        (e.innerHTML = l
          ...
          .reverse()
          .map((e) => {
            let t = `<span style="color:#666">…</span>`;
            if (e.fpsWindow && e.fpsWindow.length) {
              let n = e.fpsWindow.map((e) => e.fps),
                r = Math.min(...n),
                i = Math.max(...n);
              t = `<span style="color:${r < 50 ? `#ff5a5a` : r < 90 ? `#ffa64d` : `#7ee8c4`}">${r}–${i}</span>`;
            }
            let n = [];
            (e.maxVelocityPxPerS != null && n.push(`v=${e.maxVelocityPxPerS}`),
              e.durationMs != null && n.push(`${e.durationMs}ms`),
              e.deltaY != null && n.push(`Δy=${e.deltaY}`));
            let r = n.length
              ? ` <span style="color:#666">(${n.join(`, `)})</span>`
              : ``;
            return `<div style="padding:1px 0"><span style="color:#7ee8c4">${(e.t / 1e3).toFixed(1)}s</span> ${e.type} ${t}fps${r}</div>`;
          })
          .join(``));
    }
    function h() {
      let e = t.map((e) => e.fps).sort((e, t) => e - t),
        r = (t) => (e.length ? Math.round(e[Math.floor(e.length * t)]) : 0);
      return {
        meta: {
        ...
        perfMarks: performance
          .getEntriesByType(`mark`)
          .filter((e) => e.name.startsWith(`hero-shader:`))
        ...
        fpsTimeline: t
          .filter((e, t) => t % 10 == 0)
          .map((e) => ({ t: Math.round(e.t), fps: Math.round(e.fps) })),
        slowFrames: n
          .filter((e) => e.dt > 20)
          .map((e) => ({ t: Math.round(e.t), dt: Math.round(e.dt) })),
        longTasks: c,
        events: l,
      };
    }
    async function g() {
      let e = JSON.stringify(h(), null, 2),
        t = f(`po-copy`);
      try {
        (await navigator.clipboard.writeText(e),
          (t.textContent = `Copied!`),
          setTimeout(() => (t.textContent = `Copy JSON`), 1500));
      } catch {
        ((t.textContent = `See console`),
          console.log(
            `%c[perf-overlay] Report:`,
            `color:#B91729;font-weight:bold`,
          ),
          console.log(e),
          setTimeout(() => (t.textContent = `Copy JSON`), 2e3));
      }
    }
    function _() {
      let e = document.getElementById(`portrait-stage`);
      return e
        ? (e.addEventListener(`pointerenter`, () => u(`hover-enter-hero`)),
          e.addEventListener(`pointerleave`, () => u(`hover-leave-hero`)),
          !0)
        : !1;
    }
    function v() {
      let e = document.getElementById(`btn-menu`),
        t = document.getElementById(`site-drawer`);
      return (
        e && e.addEventListener(`click`, () => u(`nav-click`)),
        t &&
          new MutationObserver((e) => {
            for (let n of e)
              n.attributeName === `aria-hidden` &&
                u(
                  t.getAttribute(`aria-hidden`) === `false`
                    ? `nav-open`
                    : `nav-close`,
                );
          }).observe(t, { attributes: !0, attributeFilter: [`aria-hidden`] }),
        !!(e || t)
      );
    }
    function y() {
      ...
      window.addEventListener(
        ...
        () => {
          let o = performance.now(),
            s = window.scrollY;
          if ((r || ((e = o), (t = s), (n = 0), u(`scroll-start`)), i)) {
            let e = (Math.abs(s - a) / Math.max(1, o - i)) * 1e3;
            e > n && (n = e);
          }
          ((i = o),
            (a = s),
            ...
            (r = setTimeout(() => {
              (u(`scroll-end`, {
                durationMs: Math.round(o - e),
                deltaY: Math.round(s - t),
                maxVelocityPxPerS: Math.round(n),
              }),
                (r = 0));
            }, 250)));
        },
    ...
    function b() {
      if (
        ...
        f(`po-copy`).addEventListener(`click`, g),
        f(`po-clr`).addEventListener(`click`, () => {
          ((l.length = 0), m());
        }),
        !_())
      ) {
      ...
      (v(),
        y(),
        u(`session-start`),
        window.addEventListener(`preloader:done`, () => u(`preloader-done`)),
        window.addEventListener(`hero-shader:ready`, () =>
          u(`hero-shader-ready`),
        ));
    }
  ...
  (() => {
    let e = document.getElementById(`theme-audio`),
      t = document.getElementById(`audio-toggle`);
    if (!e || !t) return;
    let n = matchMedia(`(prefers-reduced-motion: reduce)`).matches,
      r = `mm:audio:muted`,
      i = sessionStorage.getItem(r),
      a = i === null ? n : i === `1`;
    ((e.volume = 0), (e.muted = a), o());
    function o() {
      (t.setAttribute(`aria-pressed`, String(!a)),
        t.classList.toggle(`is-muted`, a));
    }
    let s = 0.1;
    function c(t, n) {
      let r = e.volume,
        i = performance.now();
      (cancelAnimationFrame(e._fadeRaf || 0),
        (function a() {
          let o = Math.min(1, (performance.now() - i) / n);
          ((e.volume = r + (t - r) * o),
            o < 1 && (e._fadeRaf = requestAnimationFrame(a)));
        })());
    }
    let l = !1;
    function u() {
    ...
    let d = [`pointerdown`, `touchstart`, `keydown`, `click`];
    function f(e) {
      d.forEach((t) => {
        e.addEventListener(t, u, { once: !0, passive: !0, capture: !0 });
      });
    }
    (f(window),
      t.addEventListener(`click`, (t) => {
        (t.stopPropagation(),
          (a = !a),
          sessionStorage.setItem(r, a ? `1` : `0`),
          (e.muted = a),
          a ? c(0, 400) : (u(), c(s, 800)),
          o());
      }));
    ...
    function m(t, n, r) {
      ...
      p = setInterval(() => {
        o++;
        let n = Math.min(1, o / a);
        ((e.volume = i + (t - i) * n), n >= 1 && (clearInterval(p), r && r()));
      }, 50);
    }
    document.addEventListener(`visibilitychange`, () => {
      !l ||
        ...
        (document.hidden
          ? (cancelAnimationFrame(e._fadeRaf || 0),
            m(0, 500, () => {
              document.hidden && e.pause();
            }))
          : (clearInterval(p), e.play(), c(s, 2500)));
    });
  })());
var n = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  r = window.matchMedia(`(hover: none)`).matches,
  i = document.documentElement.dataset.tier || `high`,
  a = document.getElementById(`portrait-stage`),
  o = document.getElementById(`hero-fx`),
  s = a.querySelector(`.hover-zones .zone`);
window.__heroShader = window.__heroShader || { ready: !1 };
var c = () => {
    if (!window.__heroShader.ready) {
      window.__heroShader.ready = !0;
      try {
        window.dispatchEvent(new CustomEvent(`hero-shader:ready`));
      } catch {}
    }
  },
  l = new URLSearchParams(location.search).has(`perf`),
  u = (e) => {
    if (l)
      try {
        performance.mark(e);
  ...
  d = (e, t, n = performance.now()) => {
    l && console.log(`[hero-shader] ${e}: ${(n - t).toFixed(1)}ms`);
  },
  f = i === `low` ? 1 : i === `mid` ? 1.5 : 2,
  p = i === `low` ? `mediump` : `highp`,
  m = i === `high` ? 0.75 : i === `mid` ? 0.35 : 0,
  h = i === `high` ? 0.65 : i === `mid` ? 0.35 : 0,
  g = i === `high` ? 0.65 : i === `mid` ? 0.35 : 0,
  _ = [],
  v = !1,
  y = () => {
    v = !1;
...
if (new URLSearchParams(location.search).has(`fps`)) {
  ...
  ((e.style.cssText = `position:fixed;bottom:8px;left:8px;z-index:9999;padding:4px 8px;font:12px/1 JetBrains Mono,monospace;color:#fff;background:rgba(0,0,0,.65);border:1px solid rgba(255,255,255,.15);border-radius:4px;pointer-events:none;letter-spacing:.02em;`),
    document.addEventListener(`DOMContentLoaded`, () =>
      document.body.appendChild(e),
    ));
  let t = new Float32Array(60),
    n = 0,
    r = 0,
    i = performance.now(),
    a = (o) => {
      let s = o - i;
      ((i = o), (t[n] = s), (n = (n + 1) % t.length), r < t.length && r++);
      let c = 0;
      for (let e = 0; e < r; e++) c += t[e];
      ((e.textContent = `${(r > 0 ? (1e3 * r) / c : 0).toFixed(1)} fps · ${(c / r).toFixed(2)} ms`),
...
function S(e, t = 0.96) {
  if (!e) return;
  let n = e.classList.contains(`fit-line--bleed`),
    r = n
      ? document.documentElement
      : e.closest(`section, .hero, main`) || document.body,
    i = r.clientWidth;
  if (!n) {
    let e = getComputedStyle(r);
    i -= (parseFloat(e.paddingLeft) || 0) + (parseFloat(e.paddingRight) || 0);
  }
  let a = i * t,
    o = e.style.width;
  ((e.style.width = `max-content`), (e.style.fontSize = `100px`));
  let s = e.getBoundingClientRect().width;
  ((e.style.width = o), s > 0 && (e.style.fontSize = (100 * a) / s + `px`));
}
function C() {
  let e = document.querySelector(`.big-name`);
  (e && S(e, 0.96),
    document.querySelectorAll(`.fit-line`).forEach((e) => {
      S(e, e.classList.contains(`fit-line--bleed`) ? 0.96 : 0.94);
    }));
}
if (
  (document.fonts && document.fonts.ready
    ? document.fonts.ready.then(C)
    : window.addEventListener(`load`, C),
  C(),
  window.addEventListener(`resize`, C),
  typeof ResizeObserver < `u` && x && new ResizeObserver(C).observe(x),
  n || i === `low`)
)
  ...
  try {
    ...
    u(`hero-shader:init:start`);
    let n = a.querySelector(`.samurai-wings`),
      i = -1,
      l = NaN,
      h = NaN,
      {
      ...
      w = new g({
        canvas: o,
        alpha: !0,
        dpr: Math.min(window.devicePixelRatio, f),
    ...
    let E = new y(T),
      D = `
          ...
          void main() {
            ...
            vec4 coreMask = vec4(base.rgb * core, base.a * core);

            // film grain (full frame, subtle)
            float grain = hash(uv * uResolution * 0.5 + uTime * 60.0);
            coreMask.rgb += (grain - 0.5) * 0.055;

            gl_FragColor = coreMask;
          }
        `,
      O = (e) =>
        new Promise((t, n) => {
          ...
          ((r.crossOrigin = `anonymous`),
            (r.onload = () => {
              let e = new S(T, { image: r, generateMipmaps: !1 });
              ((e.aspect = r.naturalWidth / r.naturalHeight), t(e));
            }),
            (r.onerror = n),
            (r.src = e));
        }),
      [k, A] = await Promise.all([
        O(`../assets/mina-samurai.webp`),
        O(`../assets/mina-modern.webp`),
      ]),
      j = await O(`../assets/depth-map.webp`).catch(() => null),
      { bakeNoiseTexture: M } = await t(
        async () => {
          let { bakeNoiseTexture: e } = await import(
            `./_bake-noise-CJ5n157n.js`
          );
          return { bakeNoiseTexture: e };
        },
        [],
        import.meta.url,
      ),
      ...
      P = new _(T, {
        ...
        uniforms: {
          ...
          uDepth: { value: j || k },
          uNoiseTex: { value: N },
          uModernAspect: { value: A.aspect || 0.75 },
          uSamuraiAspect: { value: k.aspect || 0.75 },
          uDepthAspect: { value: j ? j.aspect : 0.75 },
          uHasDepth: { value: +!!j },
          uParallaxStrength: { value: 0.035 },
          uMouse: { value: [0.5, 0.5] },
          uHover: { value: 1 },
          uBlobSize: { value: 0.28 },
          uAspect: { value: 1 },
          uTime: { value: 0 },
      ...
      F = new v(T, { geometry: E, program: P }),
    ...
    function z() {
      ((I = a.getBoundingClientRect()),
        (L = window.innerWidth),
        (R = window.innerHeight),
        w.setSize(I.width, I.height),
        (P.uniforms.uResolution.value[0] = I.width),
        (P.uniforms.uResolution.value[1] = I.height),
        (P.uniforms.uAspect.value = I.height > 0 ? I.width / I.height : 1));
    }
    (window.addEventListener(`resize`, z),
      ...
      typeof ResizeObserver < `u` && new ResizeObserver(z).observe(a),
      z());
    let B = { x: 0.5, y: 0.5, tx: 0.5, ty: 0.5 },
      V = { t: 1, target: 1 },
      H = 0,
      U = 0,
      W = 0,
    ...
    (window.addEventListener(
      ...
      (e) => {
        (r && (K = performance.now()),
          (B.tx = Math.max(0, Math.min(1, (e.clientX - I.left) / I.width))),
          (B.ty =
            1 - Math.max(0, Math.min(1, (e.clientY - I.top) / I.height))));
        let t = (e.clientX / L) * 2 - 1;
        ((W = -((e.clientY / R) * 2 - 1) * 1.5), (G = t * 2.25));
      },
      { passive: !0 },
    ),
      r
        ? (a.addEventListener(`pointerdown`, (e) => {
            ((V.target = 1), (K = performance.now()));
            try {
      ...
      s.addEventListener(`focus`, () => {
        ((V.target = 1), (B.tx = 0.5), (B.ty = 0.5));
      }),
      s.addEventListener(`blur`, () => {
        V.target = 1;
      }));
    let J = P.uniforms.uMouse.value,
      Y = !0,
      X = 0;
    new IntersectionObserver(
      (e) => {
        ((Y = e[0].isIntersecting), Y && !X && (X = requestAnimationFrame(Z)));
      },
      { threshold: 0 },
    ).observe(x || a);
    function Z(e) {
      if (((X = 0), r && performance.now() - K > 1200)) {
        let t = e * 0.001;
        ((B.tx = 0.5 + 0.28 * Math.sin(t * 0.52)),
          (B.ty = 0.55 + 0.18 * Math.sin(t * 0.77 + 1.2)),
          (V.target = q),
          (W = 0),
          (G = 0));
      }
      if (
        ((B.x += (B.tx - B.x) * 0.18),
        (B.y += (B.ty - B.y) * 0.18),
        (V.t += (V.target - V.t) * 0.041666666666666664),
        (H += (W - H) * 0.06),
        (U += (G - U) * 0.06),
        (Math.abs(H - l) > 0.02 || Math.abs(U - h) > 0.02) &&
          ((l = H),
          (h = U),
          (a.style.transform = `translateX(-50%) translateY(${H * -0.8}px) rotateX(${H}deg) rotateY(${U}deg)`)),
        (J[0] = B.x),
        (J[1] = B.y),
        (P.uniforms.uHover.value = V.t),
        (P.uniforms.uTime.value = e * 0.001),
        n)
      ) {
        let e = 1 - V.t;
        Math.abs(e - i) > 0.005 && ((i = e), (n.style.opacity = e.toFixed(3)));
      }
      (w.render({ scene: F }), Y && (X = requestAnimationFrame(Z)));
    }
    if (
      (u(`hero-shader:link:poll:start`),
      T.getExtension(`KHR_parallel_shader_compile`))
    ) {
      let e = performance.now();
      (await new Promise((t) => {
        let n = () => {
          try {
            if (T.getProgramParameter(P.program, 37297)) return t();
          } catch {
            return t();
          }
          if (performance.now() - e > 500) return t();
    ...
    (u(`hero-shader:link:poll:end`), u(`hero-shader:warmup:start`));
    let ee = performance.now();
    ((o.style.opacity = `0`),
      (P.uniforms.uHover.value = 1),
      (J[0] = 0.5),
      (J[1] = 0.5),
      ...
      w.render({ scene: F }),
      T.finish(),
      d(`warmup (incl. gl.finish)`, ee),
      u(`hero-shader:warmup:end`),
      a.classList.add(`webgl-on`),
      (a.querySelector(`.portrait-fallback`).style.opacity = `0`),
      (P.uniforms.uHover.value = 0),
      u(`hero-shader:firstDraw:start`));
    let te = performance.now();
    (Z(performance.now()),
      d(`first draw`, te),
      u(`hero-shader:firstDraw:end`),
      (o.style.opacity = ``),
      d(`hero-shader total init`, e),
      c());
  } catch (e) {
    (console.warn(`[hero] WebGL shader failed, using CSS fallback.`, e), c());
  }
if (!n && i !== `low`) {
  let e = document.getElementById(`dragon-stage`),
    n = document.getElementById(`dragon-fx`),
    i = e && e.querySelector(`.dragon-hover-zone`);
  if (e && n && i) {
    let a = async () => {
        try {
          let {
          ...
          `,
            x = (e) =>
              new Promise((t, n) => {
                ...
                ((r.crossOrigin = `anonymous`),
                  (r.onload = () => {
                    let e = new l(g, { image: r, generateMipmaps: !1 });
                    ((e.aspect = r.naturalWidth / r.naturalHeight), t(e));
                  }),
                  (r.onerror = n),
                  (r.src = e));
            ...
            [S, C] = await Promise.all([
              x(`../assets/dragon-skitched.webp`),
              x(`../assets/dragon-filled.webp`),
            ]),
            w = new o(g, {
              vertex: `
            precision mediump float;
          ...
          `,
              ...
              uniforms: {
                ...
                uFilled: { value: C },
                uNoiseTex: { value: _ },
                uSketchAspect: { value: S.aspect || 1.5 },
                uFilledAspect: { value: C.aspect || 1.5 },
                uMouse: { value: [0.5, 0.5] },
                uHover: { value: 0 },
                uBlobSize: { value: 0.32 },
                uAspect: { value: 1 },
                uTime: { value: 0 },
                uResolution: { value: [1, 1] },
              },
            ...
            T = new s(g, { geometry: v, program: w }),
            E = e.getBoundingClientRect();
          function D() {
            ((E = e.getBoundingClientRect()),
              !(E.width <= 0 || E.height <= 0) &&
                (m.setSize(E.width, E.height),
                (w.uniforms.uResolution.value[0] = E.width),
                (w.uniforms.uResolution.value[1] = E.height),
                (w.uniforms.uAspect.value = E.width / E.height)));
          }
          (window.addEventListener(`resize`, D),
            ...
            typeof ResizeObserver < `u` && new ResizeObserver(D).observe(e),
            D());
          let O = { x: 0.5, y: 0.5, tx: 0.5, ty: 0.5 },
            k = { t: 0, target: 0 },
            A = w.uniforms.uMouse.value,
            j = 0,
            M = h,
          ...
          (window.addEventListener(`resize`, P),
            b(P),
            typeof ResizeObserver < `u` && new ResizeObserver(P).observe(e));
          let F = (e, t, n) =>
              !!n && e >= n.left && e <= n.right && t >= n.top && t <= n.bottom,
            I = (e) => {
              (r && (j = performance.now()),
                F(e.clientX, e.clientY, N)
                  ? ((O.tx = Math.max(
                      0,
                      Math.min(1, (e.clientX - E.left) / E.width),
                    )),
                    (O.ty =
                      1 -
                      Math.max(0, Math.min(1, (e.clientY - E.top) / E.height))),
                    (k.target = 1))
                  : (k.target = 0));
            };
          (window.addEventListener(`pointermove`, I, { passive: !0 }),
            window.addEventListener(`pointerdown`, I, { passive: !0 }),
            r &&
          ...
          new IntersectionObserver(
            (e) => {
              for (let t of e) L = t.isIntersecting && t.intersectionRatio > 0;
              L && !R && (R = requestAnimationFrame(z));
            },
            { threshold: [0, 0.05] },
          ).observe(e);
          function z(e) {
            if (r && performance.now() - j > 1200)
              if (L) {
                let t = e * 0.001;
                ((O.tx = 0.5 + 0.12 * Math.sin(t * 0.48)),
                  (O.ty = 0.5 + 0.18 * Math.sin(t * 0.71 + 0.9)),
                  (k.target = M));
              } else k.target = 0;
            ((O.x += (O.tx - O.x) * 0.12),
              (O.y += (O.ty - O.y) * 0.12),
              (k.t += (k.target - k.t) * 0.08),
              (A[0] = O.x),
              (A[1] = O.y),
              (w.uniforms.uHover.value = k.t),
              (w.uniforms.uTime.value = e * 0.001),
              m.render({ scene: T }),
              (R = L || k.t > 0.001 ? requestAnimationFrame(z) : 0));
          }
          (e.classList.add(`webgl-on`), (R = requestAnimationFrame(z)));
        } catch (e) {
          console.warn(`[dragon] WebGL shader failed, using CSS fallback.`, e);
        }
      },
      o = !1,
...
if (!n && i !== `low`) {
  let e = document.getElementById(`liberty-stage`),
    n = document.getElementById(`liberty-fx`),
    i = e && e.querySelector(`.liberty-hover-zone`);
  if (e && n && i) {
    let a = async () => {
        try {
          let {
          ...
          `,
            x = (e) =>
              new Promise((t, n) => {
                ...
                ((r.crossOrigin = `anonymous`),
                  (r.onload = () => {
                    let e = new l(h, { image: r, generateMipmaps: !1 });
                    ((e.aspect = r.naturalWidth / r.naturalHeight), t(e));
                  }),
                  (r.onerror = n),
                  (r.src = e));
            ...
            [S, C] = await Promise.all([
              x(`../assets/liberty-sketch.webp`),
              x(`../assets/liberty-filled.webp`),
            ]),
            w = new o(h, {
              vertex: `
            precision mediump float;
          ...
          `,
            ...
            T = new s(h, { geometry: v, program: w }),
            E = e.getBoundingClientRect();
          function D() {
            ((E = e.getBoundingClientRect()),
              !(E.width <= 0 || E.height <= 0) &&
          ...
          (window.addEventListener(
            ...
            (e) => {
              r && (j = performance.now());
              let t = (e.clientX - E.left) / E.width,
                n = (e.clientY - E.top) / E.height;
              ((O.tx = Math.max(0, Math.min(1, t))),
                (O.ty = 1 - Math.max(0, Math.min(1, n))),
                r ||
                  (k.target = +(t > 0.08 && t < 0.92 && n > 0.06 && n < 0.94)));
            },
            { passive: !0 },
          ),
            r
              ? (i.addEventListener(`pointerdown`, (e) => {
                  ((k.target = 1), (j = performance.now()));
                  try {
                  ...
                  ((O.tx = Math.max(
                    ...
                    (O.ty =
                      ...
                      Math.max(
                        0,
                        Math.min(1, (e.clientY - E.top) / E.height),
                      )));
                }),
          ...
          new IntersectionObserver(
            (e) => {
              for (let t of e) N = t.isIntersecting && t.intersectionRatio > 0;
              N && !P && (P = requestAnimationFrame(F));
            },
            { threshold: [0, 0.05] },
          ).observe(e);
          function F(e) {
            if (r && performance.now() - j > 1200)
              if (N) {
                let t = e * 0.001;
                ((O.tx = 0.5 + 0.22 * Math.sin(t * 0.46)),
                  (O.ty = 0.5 + 0.18 * Math.sin(t * 0.69 + 1.4)),
                  (k.target = M));
              } else k.target = 0;
            ((O.x += (O.tx - O.x) * 0.12),
              (O.y += (O.ty - O.y) * 0.12),
              ...
              (w.uniforms.uTime.value = e * 0.001),
              m.render({ scene: T }),
              (P = N || k.t > 0.001 ? requestAnimationFrame(F) : 0));
          }
          (e.classList.add(`webgl-on`), (P = requestAnimationFrame(F)));
        } catch (e) {
          console.warn(`[liberty] WebGL shader failed, using CSS fallback.`, e);
        }
      },
      o = !1,
      s = new IntersectionObserver(
...
var w = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  T = document.documentElement.dataset.tier || `high`,
  E = T === `high`;
if (w) document.documentElement.classList.remove(`js-enabled`);
else
  try {
    let n = T !== `low`,
      [{ gsap: r }, { ScrollTrigger: i }, a, o] = await Promise.all([
        t(
          () => import(`./gsap-C_F2famk.js`),
          __vite__mapDeps([2, 3]),
          import.meta.url,
        ),
        t(
          () => import(`./ScrollTrigger-C0K7cnyT.js`),
          __vite__mapDeps([4, 3]),
          import.meta.url,
        ),
        t(
          () => import(`./splitting-oi4GEGE6.js`).then((t) => e(t.default, 1)),
    ...
    (n &&
      ...
      document.addEventListener(`click`, (e) => {
        ...
        r &&
          (e.preventDefault(),
          c
            ? c.scrollTo(r, { offset: 0, duration: 1.2 })
            : r.scrollIntoView({ behavior: `smooth`, block: `start` }));
      }),
      document.querySelectorAll(`.mq`).forEach((e, t) => {
        let n = e.querySelector(`.mq-track`);
        ...
        r.fromTo(
          n,
          { xPercent: a < 0 ? 0 : -50 },
          { xPercent: a < 0 ? -50 : 0, duration: i, ease: `none`, repeat: -1 },
        );
      }),
      document.querySelectorAll(`.cta-mq`).forEach((e, t) => {
        let n = e.querySelector(`.cta-mq-track`);
        n.innerHTML += n.innerHTML;
        let i = t % 2 == 0 ? -1 : 1;
        r.fromTo(
          n,
    ...
    let l = (e, t, n) => {
      Array.from(e).forEach((e) => {
        ...
        ((r.className = n), e.parentNode.insertBefore(r, e), r.appendChild(e));
      });
    };
    function u(e, t, n, i) {
      switch (t) {
        case `char-variation-1`:
          e.fromTo(
            ...
            E
              ...
              : { skewX: -30, opacity: 0, willChange: `opacity, transform` },
            E
              ? {
                  skewX: 0,
        ...
        case `char-variation-3`:
          e.fromTo(
            n,
            {
              willChange: `opacity, transform`,
              opacity: 0,
              xPercent: () => r.utils.random(-200, 200),
              yPercent: () => r.utils.random(-150, 150),
            },
            {
              ease: `power1.inOut`,
              opacity: 1,
        ...
        case `char-variation-5`:
          (l(n, `span`, `char-wrap`),
            e.fromTo(
              ...
              { duration: 1.35, ease: `expo.out`, xPercent: 0, stagger: 0.06 },
            ));
          break;
        ...
        case `word-variation-1`:
          e.fromTo(
            ...
            E
              ...
              : { willChange: `opacity, transform`, opacity: 0, yPercent: 10 },
            E
              ? {
                  duration: 0.55,
                  ease: `power2.out`,
        ...
        case `word-variation-3`:
          (i.forEach((e) => r.set(e.parentNode, { perspective: 1e3 })),
            e.fromTo(
              i,
              {
                willChange: `opacity, transform`,
                z: () => r.utils.random(500, 950),
                opacity: 0,
                xPercent: () => r.utils.random(-100, 100),
                yPercent: () => r.utils.random(-10, 10),
                rotationX: () => r.utils.random(-90, 90),
              },
              {
                ease: `expo`,
                opacity: 1,
    ...
    function d(e) {
      return e.classList.contains(`js-split`)
        ? {
            chars: e.querySelectorAll(`.char`),
            words: e.querySelectorAll(`.word`),
          }
        : (e.classList.add(`js-split`),
          s({ target: e, by: `chars` }),
          (e.style.visibility = ``),
          {
            chars: e.querySelectorAll(`.char`),
    ...
    function f(e, { scrollTrigger: t } = {}) {
      if (!e) return;
      let n = e.dataset.textEffect;
      if (!n) return;
      let { chars: a, words: o } = d(e);
      if ((!a || !a.length) && (!o || !o.length)) return;
      let s = r.timeline({ paused: !0 });
      (u(s, n, a, o),
        s.pause(0),
        t
          ? i.create({
    ...
    (document.querySelectorAll(`.hero [data-text-effect]`).forEach((e) => f(e)),
      document
        .querySelectorAll(`main > section.chapter [data-text-effect]`)
        .forEach((e) => {
          f(e, {
            scrollTrigger: {
              trigger: e.closest(`section.chapter`),
              start: `top 70%`,
            },
          });
        }),
      document.querySelectorAll(`[data-scroll-reveal]`).forEach((e) => {
        let { words: t } = d(e);
        !t ||
          !t.length ||
          (e.classList.add(`is-scroll-reveal`),
          r.set(t, {
            clipPath: `inset(-10% 100% -10% 0%)`,
            opacity: 0.18,
            skewX: -8,
            ...(E ? { filter: `blur(14px) saturate(0)` } : {}),
            willChange: E
              ? `opacity, filter, transform, clip-path`
      ...
      i.refresh(),
      document.querySelectorAll(`main > section.chapter`).forEach((e) => {
        let t = e.querySelectorAll(
          `:scope > .ch-head, :scope > .ch-sub, :scope > .about-grid > *, :scope > .stat-grid .stat, :scope > .work-list .work-row, :scope > .work-all, :scope > .road-rail, :scope > .manifesto-list li, :scope > .contact-socials li, :scope > .site-foot`,
        );
        t.length &&
          r.to(t, {
            opacity: 1,
            ...
            ease: `power3.out`,
            stagger: 0.04,
            scrollTrigger: { trigger: e, start: `top 78%`, once: !0 },
          });
      }),
      document.querySelectorAll(`.stat-value[data-count]`).forEach((e) => {
        let t = parseInt(e.dataset.count, 10),
          n = e.innerHTML.includes(`sup`) ? `<sup>+</sup>` : ``,
          i = { v: 0 };
        r.to(i, {
          v: t,
          duration: 1.8,
          ease: `power2.out`,
          onUpdate: () => {
            e.innerHTML = Math.round(i.v) + n;
          },
          scrollTrigger: { trigger: e, start: `top 85%`, once: !0 },
        });
      }));
  } catch (e) {
    (console.warn(`[chapters] GSAP/ScrollTrigger failed to load.`, e),
      document.documentElement.classList.remove(`js-enabled`));
  }
(function () {
  let e = Array.from(document.querySelectorAll(`.chapter-rail li`)),
    t = Array.from(document.querySelectorAll(`main > section`));
  if (!e.length || !t.length || typeof IntersectionObserver > `u`) return;
  let n = new IntersectionObserver(
    (n) => {
      n.forEach((n) => {
        if (!n.isIntersecting) return;
        let r = t.indexOf(n.target);
        r < 0 || e.forEach((e, t) => e.classList.toggle(`is-active`, t === r));
      });
    },
...
var D = 241,
  O = (e) => `../assets/kitsune-frames/frame_${String(e).padStart(4, `0`)}.webp`,
  k = 241,
  A = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  j = document.querySelector(`.kitsune-runway`),
  M = document.querySelector(`.kitsune-canvas-wrap`),
  N = document.getElementById(`kitsune-canvas`),
  P = document.querySelector(`.kitsune-outro`),
  F = Array.from(document.querySelectorAll(`.kitsune-chapter`));
if (j && M && N) {
  let e = N.getContext(`2d`, { alpha: !0 }),
    ...
    i = 0,
    a = 0,
    o = () => Math.max(1, Math.min(2, window.devicePixelRatio || 1)),
    s = () => {
      let t = M.getBoundingClientRect(),
        n = o(),
        i = Math.round(t.width * n),
        a = Math.round(t.height * n);
  ...
  typeof ResizeObserver < `u` && new ResizeObserver(() => s()).observe(M);
  let c = (t) => {
      let r = n[t];
      if (!r || !r.complete || r.naturalWidth === 0) {
        console.warn(`[kitsune] Frame ${t} not ready. Loaded: ${n.filter(x => x && x.complete && x.naturalWidth > 0).length}/${D}`);
        return;
      }
      let i = o(),
        a = N.width / i,
        s = N.height / i;
      e.clearRect(0, 0, a, s);
      let c = Math.min(a / r.naturalWidth, s / r.naturalHeight),
        l = r.naturalWidth * c,
        u = r.naturalHeight * c;
      e.drawImage(r, (a - l) / 2, (s - u) / 2, l, u);
      console.log(`[kitsune] Frame ${t}/${D-1}`);
    },
    l = (e) => {
      let t = n[e];
      if (t && t.complete && t.naturalWidth > 0) return e;
      for (let t = 1; t < D; t++) {
        let r = e - t;
        if (r >= 0) {
          let e = n[r];
          if (e && e.complete && e.naturalWidth > 0) return r;
        }
        let i = e + t;
        if (i < D) {
          let e = n[i];
          if (e && e.complete && e.naturalWidth > 0) return i;
        }
      }
      return 0;
    },
    u = () => {
      let e = l(Math.max(0, Math.min(D - 1, Math.round(i))));
      if (e !== r) {
        console.log(`[kitsune] Scroll progress frame index: ${Math.round(i)} -> nearest loaded: ${e}`);
        c(e);
        r = e;
      }
    },
        ...
        for (let e = 0; e < D; e++) {
          ...
          ((t.decoding = `async`),
            e === 0
              ...
              : e >= k && (t.fetchPriority = `low`),
            (t.onload = () => {
              ((n[e] = t),
                e === 0 && (M.classList.add(`is-ready`), c(0)),
                e < k && o());
            }),
            (t.onerror = () => {
              e < k && o();
    ...
    f = () => {
      let e = j.getBoundingClientRect(),
        ...
        n = e.height - t;
      return n <= 0 ? 0 : Math.max(0, Math.min(1, -e.top / n));
    };
  if (A) {
    let e = new Image();
    ((e.onload = () => {
      ((n[0] = e), M.classList.add(`is-ready`), s());
    }),
      (e.src = O(1)));
  } else
    Promise.all([
      ...
      .then(([{ gsap: e }, { ScrollTrigger: t }]) => {
        e.registerPlugin(t);
        let n = document.getElementById(`ch-numbers`),
          r = document.getElementById(`ch-kitsune`);
        if (n && r) {
          let i = Array.from(n.querySelectorAll(`.stat-value`)).filter(
              (e) => !e.closest(`.stat-inf`),
            ),
            a = n.querySelectorAll(`.stat-label`),
            o = n.querySelectorAll(`.stat-note`),
            s = n.querySelectorAll(`.stat`),
            c = n.querySelector(`.stat-grid`),
            l = n.querySelector(`.ch-kicker`),
            u = n.querySelector(`.ch-meta`),
            d = e.timeline({ paused: !0 }),
            f = 0.7,
            p = `power2.inOut`;
          (d
            .to(n, { backgroundColor: `#FBF7F0`, duration: f, ease: p }, 0)
            .to(s, { backgroundColor: `#FBF7F0`, duration: f, ease: p }, 0)
            .to(i, { color: `#0A0A0A`, duration: f, ease: p }, 0)
            .to(a, { color: `#0A0A0A`, duration: f, ease: p }, 0)
            .to(
              o,
              { color: `rgba(10, 10, 10, 0.62)`, duration: f, ease: p },
              0,
            ),
            l && d.to(l, { color: `#0A0A0A`, duration: f, ease: p }, 0),
            u &&
              d.to(
                u,
                { color: `rgba(10, 10, 10, 0.38)`, duration: f, ease: p },
                0,
              ),
            c &&
              d.to(
        ...
        let o = F.map((e) => {
          let t = e.querySelector(`.k-side-left`),
            n = e.querySelector(`.k-side-right`);
          return {
            left: t,
            right: n,
            leftLines: Array.from(t ? t.querySelectorAll(`.k-line-inner`) : []),
            rightLines: Array.from(
              n ? n.querySelectorAll(`.k-line-inner`) : [],
            ),
          };
        });
        o.forEach(({ left: t, right: n, leftLines: r, rightLines: i }) => {
          (t && e.set(t, { autoAlpha: 0, x: -60 }),
            n && e.set(n, { autoAlpha: 0, x: 60 }),
            e.set(r, { yPercent: 110 }),
            e.set(i, { yPercent: 110 }));
        });
        let c = -1,
          l = -1,
          p = !1,
          m = () => {
            ...
            if (t >= 0) {
              let { left: e, right: n, leftLines: i, rightLines: a } = o[t];
              (r.to(
                [...i, ...a],
                {
                  yPercent: -110,
                ...
                e &&
                  r.to(
                    e,
                    { x: -60, autoAlpha: 0, duration: 0.45, ease: `power2.in` },
                    0.1,
                  ),
                n &&
                  r.to(
                ...
                r.set([...i, ...a], { yPercent: 110 }));
            }
            if (n >= 0) {
              let { left: e, right: t, leftLines: i, rightLines: a } = o[n];
              (r.set([...i, ...a], { yPercent: 110 }),
                e && r.set(e, { x: -60, autoAlpha: 0 }),
                t && r.set(t, { x: 60, autoAlpha: 0 }),
                e &&
                  r.to(
                    e,
          ...
          g = (e) => {
            for (let t = 0; t < F.length; t++) {
              let n = parseFloat(F[t].dataset.show),
                r = parseFloat(F[t].dataset.hide);
              if (e >= n && e <= r) return t;
            }
            return -1;
          },
          _ = (t) => {
            let n = Math.max(0, Math.min(1, t / 0.06)),
              r = Math.max(0, Math.min(1, (t - 0.92) / 0.08)),
              i = (0.88 + 0.12 * n) * (1 - 0.06000000000000005 * r),
              a = (0.3 + 0.7 * n) * (1 - 0.3 * r);
            (e.set(M, { scale: i, autoAlpha: a }),
              P && e.set(P, { autoAlpha: 0.3 + 0.7 * r }));
          },
          v = () => {
            a = 0;
            let e = f();
            console.log(`[kitsune] Scroll progress: ${e.toFixed(3)}`);
            ((i = e * (D - 1)), u(), _(e), h(g(e)));
          },
          y = () => {
...
var I = 383,
  L = (e) =>
    `../assets/inspiration-frames/frame_${String(e).padStart(4, `0`)}.webp`,
  R = 383,
  z = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  B = document.querySelector(`.hitomi-runway`),
  V = document.querySelector(`.hitomi-canvas-wrap`),
  H = document.getElementById(`hitomi-canvas`),
  U = document.querySelector(`.hitomi-outro`),
  W = Array.from(document.querySelectorAll(`.hitomi-chapter`));
if (B && V && H) {
  let e = H.getContext(`2d`, { alpha: !0 }),
    n = Array(I).fill(null),
    r = -1,
    i = 0,
    a = 0,
  ...
  typeof ResizeObserver < `u` && new ResizeObserver(() => s()).observe(V);
  let c = window.matchMedia(`(max-width: 900px)`),
    l = (t) => {
      let r = n[t];
      ...
      let i = o(),
        ...
        s = H.height / i;
      e.clearRect(0, 0, a, s);
      let l = (c.matches ? Math.min : Math.max)(
          a / r.naturalWidth,
          s / r.naturalHeight,
        ),
        u = r.naturalWidth * l,
    ...
    d = () => {
      let e = u(Math.max(0, Math.min(I - 1, Math.round(i))));
      e !== r && (l(e), (r = e));
    },
    f = () =>
      new Promise((e) => {
        ...
        for (let e = 0; e < I; e++) {
          ...
          ((t.decoding = `async`),
            e === 0
              ? (t.fetchPriority = `high`)
              : e >= R && (t.fetchPriority = `low`),
            (t.onload = () => {
              ((n[e] = t),
                e === 0 && (V.classList.add(`is-ready`), l(0)),
                e < R && o());
            }),
            (t.onerror = () => {
              e < R && o();
  ...
  if (z) {
    let e = new Image();
    ((e.onload = () => {
      ((n[0] = e), V.classList.add(`is-ready`), s());
    }),
      (e.src = L(1)));
  } else
    Promise.all([
      ...
      .then(([{ gsap: e }, { ScrollTrigger: t }]) => {
        e.registerPlugin(t);
        let n = W.map((e) => {
          let t = e.querySelector(`.h-side-left`),
            n = e.querySelector(`.h-side-right`);
          return {
            left: t,
            right: n,
            leftLines: Array.from(t ? t.querySelectorAll(`.h-line-inner`) : []),
            rightLines: Array.from(
              n ? n.querySelectorAll(`.h-line-inner`) : [],
            ),
          };
        });
        n.forEach(({ left: t, right: n, leftLines: r, rightLines: i }) => {
          (t && e.set(t, { autoAlpha: 0, x: -60 }),
            n && e.set(n, { autoAlpha: 0, x: 60 }),
            e.set(r, { yPercent: 110 }),
            e.set(i, { yPercent: 110 }));
        ...
        let r = -1,
          ...
          l = () => {
            ...
            if (t >= 0) {
              let { left: e, right: r, leftLines: i, rightLines: o } = n[t];
              (a.to(
                [...i, ...o],
                {
                  yPercent: -110,
                ...
                a.set([...i, ...o], { yPercent: 110 }));
            }
            if (i >= 0) {
              let { left: e, right: t, leftLines: r, rightLines: o } = n[i];
              (a.set([...r, ...o], { yPercent: 110 }),
                e && a.set(e, { x: -60, autoAlpha: 0 }),
                t && a.set(t, { x: 60, autoAlpha: 0 }),
                e &&
                  a.to(
                    e,
                    { x: 0, autoAlpha: 1, duration: 0.7, ease: `power3.out` },
          ...
          m = (e) => {
            for (let t = 0; t < W.length; t++) {
              let n = parseFloat(W[t].dataset.show),
                r = parseFloat(W[t].dataset.hide);
              if (e >= n && e <= r) return t;
            }
            return -1;
          },
          h = (t) => {
            let n = Math.max(0, Math.min(1, t / 0.06)),
              r = Math.max(0, Math.min(1, (t - 0.92) / 0.08)),
              i =
                (0.96 + 0.040000000000000036 * n) *
                (1 - 0.020000000000000018 * r),
              a = (0.3 + 0.7 * n) * (1 - 0.25 * r);
            (e.set(V, { scale: i, autoAlpha: a }),
              U && e.set(U, { autoAlpha: 0.3 + 0.7 * r }));
          },
          g = () => {
            a = 0;
            let e = p();
...
}
{
  let e = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
    n = window.matchMedia(`(hover: none)`).matches,
    r = document.documentElement.dataset.tier || `high`,
    i = document.getElementById(`ch-countries`),
    a = i && i.querySelector(`.countries-stick`),
    o = document.getElementById(`countries-stage`),
    s = document.getElementById(`countries-fx`),
    c = document.getElementById(`countries-progress`),
    l = c && c.querySelector(`.countries-progress__fill`),
    u = i ? Array.from(i.querySelectorAll(`.country-story`)) : [],
    d = o ? Array.from(o.querySelectorAll(`.countries-fallback__img`)) : [],
    f = i ? Array.from(i.querySelectorAll(`.cultural-bg-layer`)) : [];
  if (i && a && o && s && c && l) {
    let p = r === `low` ? 1 : r === `mid` ? 1.5 : 2,
      m = r === `low` ? 2 : 4,
      h = r === `low` ? `mediump` : `highp`,
      g = [
        { fromIdx: 0, toIdx: 1, startP: 0, endP: 0.5 },
        { fromIdx: 1, toIdx: 2, startP: 0.5, endP: 1 },
      ],
      _ = [0.5],
      v = [
        {
          name: `anubis`,
          img: `../assets/anubis/anubis.webp`,
          depth: `../assets/anubis/anubis-depthmap.webp`,
        },
        {
          name: `liberty`,
          img: `../assets/liberty/liberty.webp`,
          depth: `../assets/liberty/liberty-depth-map.webp`,
        },
        {
          name: `kangaroo`,
          img: `../assets/kangaroo/kangaroo.webp`,
          depth: `../assets/kangaroo/kangaroo-depth-map.webp`,
        },
      ],
      y = !1,
      b = [],
    ...
    let S = (e) => b.push(e),
      ...
      T = () => {
        ((C = i.getBoundingClientRect()), (w = window.innerHeight));
      };
    (window.addEventListener(`resize`, T, { passive: !0 }), S(T));
    let E = () => {
        let e = C.height - w;
        return e <= 0 ? 0 : -C.top / e;
      },
      D = (e) => {
        let t = 0;
        for (let n = 0; n < _.length; n++) e >= _[n] && (t = n + 1);
        let n = g[t],
          r = (e - n.startP) / (n.endP - n.startP);
        return {
          transIdx: t,
          fromIdx: n.fromIdx,
          toIdx: n.toIdx,
          mix: Math.max(0, Math.min(1, r)),
        };
      },
      O = (e) => {
        for (let t = 0; t < d.length; t++)
          d[t].classList.toggle(`is-active`, t === e);
      },
      k = (e, t, n) => {
        for (let r = 0; r < f.length; r++) {
          ...
          (r === e && r === t
            ...
            : r === e
              ? (i = 1 - n)
              : r === t && (i = n),
            (f[r].style.opacity = (i * 0.16).toFixed(3)));
        }
      },
      A = [
        { in: 0.02, out: 0.38 },
      ...
      j = (e) => {
        for (let t = 0; t < u.length && t < A.length; t++) {
          let n = A[t];
          u[t].style.opacity = e >= n.in && e < n.out ? `1` : `0`;
        }
      },
      M = (e, t, n) => {
      ...
      N = (e, t) => {
        c.classList.toggle(`is-visible`, t);
        let n = Math.max(0, Math.min(1, e));
        l.parentElement.style.setProperty(`--progress`, n.toFixed(4));
      };
    if (e || r === `low`) {
      ((s.style.display = `none`), O(0));
      let e = () => {
        let e = E();
        N(e, e > -0.02 && e < 1.02);
        ...
        j(t);
        let n = D(t);
        (O(n.mix > 0.5 ? n.toIdx : n.fromIdx), k(n.fromIdx, n.toIdx, n.mix));
      };
      (S(e), window.addEventListener(`load`, e), e());
    } else
      (async () => {
        try {
          let {
            ...
            f = new e({
              canvas: s,
              alpha: !0,
              dpr: Math.min(window.devicePixelRatio, p),
              powerPreference: `high-performance`,
            }),
            g = f.gl;
          g.clearColor(0, 0, 0, 0);
          ...
          `,
            b = (e) =>
              new Promise((t) => {
                ...
                ((n.crossOrigin = `anonymous`),
                  (n.onload = () => {
                    let e = new d(g, { image: n, generateMipmaps: !1 });
                    ((e.aspect = n.naturalWidth / n.naturalHeight), t(e));
                  }),
                  (n.onerror = () => t(null)),
                  (n.src = e));
              }),
            x = await Promise.all(
              v.map(async (e) => {
                let [t, n] = await Promise.all([b(e.img), b(e.depth)]);
                return { tex: t, depth: n };
              }),
            );
          if (x.some((e) => !e.tex)) {
            console.warn(
              `[countries] missing portrait texture — CSS fallback retained`,
            );
            return;
          }
          let C = new i(g, {
          ...
          `,
              ...
              uniforms: {
                uTexA: { value: x[0].tex },
                uTexB: { value: x[1].tex },
                uDepthA: { value: x[0].depth || x[0].tex },
                uDepthB: { value: x[1].depth || x[1].tex },
                uAspectA: { value: x[0].tex.aspect },
                uAspectB: { value: x[1].tex.aspect },
                uDepthAspectA: { value: (x[0].depth || x[0].tex).aspect },
                uDepthAspectB: { value: (x[1].depth || x[1].tex).aspect },
                uHasDepthA: { value: +!!x[0].depth },
                uHasDepthB: { value: +!!x[1].depth },
                uMix: { value: 0 },
                uMouse: { value: [0.5, 0.5] },
                uHover: { value: 0 },
                uAspect: { value: 1 },
            ...
            w = new c(g, { geometry: _, program: C }),
            T = o.getBoundingClientRect(),
            A = new Float32Array(u.length);
          function j() {
            for (let e = 0; e < u.length; e++) {
              let t = u[e].getBoundingClientRect();
              A[e] =
                T.width > 0 ? (t.left + t.width / 2 - T.left) / T.width : 0.5;
            }
          }
          function P() {
            ((T = o.getBoundingClientRect()),
              !(T.width <= 0 || T.height <= 0) &&
                ...
                (C.uniforms.uResolution.value[0] = T.width),
                (C.uniforms.uResolution.value[1] = T.height),
                (C.uniforms.uAspect.value = T.width / T.height),
                j()));
          }
          (window.addEventListener(`resize`, P),
            ...
            typeof ResizeObserver < `u` && new ResizeObserver(P).observe(o),
            P());
          let F = 0,
            I = 0,
            L = 1,
            R = (e, t) => {
              let n = x[t];
              e === `A`
                ? ((C.uniforms.uTexA.value = n.tex),
                  (C.uniforms.uDepthA.value = n.depth || n.tex),
                  (C.uniforms.uAspectA.value = n.tex.aspect),
                  (C.uniforms.uDepthAspectA.value = (n.depth || n.tex).aspect),
                  (C.uniforms.uHasDepthA.value = +!!n.depth),
                  (I = t))
                : ((C.uniforms.uTexB.value = n.tex),
                  (C.uniforms.uDepthB.value = n.depth || n.tex),
                  (C.uniforms.uAspectB.value = n.tex.aspect),
                  (C.uniforms.uDepthAspectB.value = (n.depth || n.tex).aspect),
                  (C.uniforms.uHasDepthB.value = +!!n.depth),
                  (L = t));
            },
            z = { x: 0.5, y: 0.5, tx: 0.5, ty: 0.5 },
            B = { t: 0, target: 0 },
            V = C.uniforms.uMouse.value,
            H = 0,
            U = r === `high` ? 0.6 : 0.3,
            W = 0.55,
            G = (e, t) => {
          ...
          (window.addEventListener(
            ...
            (e) => {
              n && (H = performance.now());
              let t = (e.clientX - T.left) / T.width,
          ...
          let K = { mix: 0, targetMix: 0, fromIdx: 0, toIdx: 1 },
            q = new Float32Array(u.length).fill(-1),
            J = !1,
            Y = 0;
          new IntersectionObserver(
            (e) => {
              for (let t of e) J = t.isIntersecting && t.intersectionRatio > 0;
              J && !Y && (Y = requestAnimationFrame(Z));
            },
          ...
          function X() {
            ...
            let r = D(n),
              i = r.transIdx !== F;
            ((F = r.transIdx),
              I !== r.fromIdx && R(`A`, r.fromIdx),
              L !== r.toIdx && R(`B`, r.toIdx),
              (K.targetMix = r.mix),
              (K.fromIdx = r.fromIdx),
              (K.toIdx = r.toIdx),
              i && (K.mix = r.mix),
              O(r.mix > 0.5 ? r.toIdx : r.fromIdx));
          }
          (S(X), window.addEventListener(`load`, X), X());
          function Z(e) {
            if (((Y = 0), n && J && performance.now() - H > 1200)) {
              let t = e * 0.001;
              ((z.tx = 0.5 + 0.22 * Math.sin(t * 0.48)),
                (z.ty = 0.55 + 0.14 * Math.sin(t * 0.71 + 1.1)),
                (B.target = U));
            }
            ((z.x += (z.tx - z.x) * 0.14),
              (z.y += (z.ty - z.y) * 0.14),
              (B.t += (B.target - B.t) * 0.08),
              (K.mix += (K.targetMix - K.mix) * 0.18),
              K.targetMix === 0 && K.mix < 0.0015
                ? (K.mix = 0)
                : K.targetMix === 1 && K.mix > 0.9985 && (K.mix = 1),
              (V[0] = z.x),
              (V[1] = z.y),
              (C.uniforms.uHover.value = B.t),
              (C.uniforms.uMix.value = K.mix),
              (C.uniforms.uTime.value = e * 0.001));
            let t = (z.y - 0.5) * 1.2 * B.t,
              r = (z.x - 0.5) * -1.8 * B.t;
            o.style.transform = `perspective(900px) rotateX(${t.toFixed(3)}deg) rotateY(${r.toFixed(3)}deg)`;
            let i = -0.25 + 1.5 * K.mix,
              a = 0.12;
            for (let e = 0; e < u.length; e++) {
              let t = u[e],
                n = 0;
              if (e === K.fromIdx && e === K.toIdx) n = 1;
              else if (e === K.fromIdx) {
                let t = 1 - A[e];
                n = 1 - M(t - a, t + a, i);
              } else if (e === K.toIdx) {
              ...
              Math.abs(n - q[e]) > 0.005 &&
                ((t.style.opacity = n.toFixed(3)),
                (t.style.filter = `blur(${((1 - n) * 4).toFixed(2)}px)`),
                (q[e] = n));
            }
            (k(K.fromIdx, K.toIdx, K.mix), f.render({ scene: w }));
            let s =
              Math.abs(K.targetMix - K.mix) > 5e-4 ||
              Math.abs(z.tx - z.x) > 0.002 ||
              Math.abs(B.target - B.t) > 0.002;
            (J || s) && (Y = requestAnimationFrame(Z));
          }
          (o.classList.add(`webgl-on`),
            o.style.setProperty(`--shader`, `1`),
            (Y = requestAnimationFrame(Z)));
        } catch (e) {
          console.warn(`[countries] WebGL failed, CSS fallback retained.`, e);
        }
      })();
  }
}
var G = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
  K = window.matchMedia(`(hover: none)`).matches,
  q = document.documentElement.dataset.tier || `high`,
  J = document.getElementById(`ch-contact`),
  Y = document.getElementById(`contact-fx`),
  X = q === `low` ? 0.75 : q === `mid` ? 1 : 1.25,
  Z = q === `low` ? 1 : 2,
  ee = `mediump`,
  te = q === `low` ? 0 : q === `mid` ? 4 : 8,
  ne = 1e3 / (q === `low` ? 24 : q === `mid` ? 30 : 40);
!J ||
  !Y ||
  (G || q === `low`
    ...
    : re().catch((e) => {
        console.warn(
          `[contact] underwater shader failed, SVG fallback retained.`,
          e,
        );
      }));
async function re() {
  let {
      ...
      async () => {
        ...
        return { Renderer: e, Program: t, Mesh: n, Triangle: r };
      },
      [],
      import.meta.url,
    ),
    a = new e({
      canvas: Y,
      alpha: !0,
      dpr: Math.min(window.devicePixelRatio || 1, X),
      powerPreference: `high-performance`,
  ...
  `,
    l = [],
    u = [];
  for (let e = 0; e < 6; e++) (l.push([0, 0, -1]), u.push(0));
  let d = new n(o, {
      vertex: `
    precision mediump float;
    attribute vec2 uv;
  ...
  `,
      ...
      uniforms: {
        ...
        uMouse: { value: [0.5, 0.5] },
        uHover: { value: 0 },
        uColSurface: { value: [0.03, 0.005, 0.01] },
        uColMid: { value: [0.012, 0.003, 0.006] },
        uColAbyss: { value: [0.003, 0.001, 0.002] },
        uColCaustic: { value: [0.55, 0.07, 0.11] },
        uColParticle: { value: [0.45, 0.06, 0.1] },
        uRipples: { value: l },
        uRippleStrength: { value: u },
      },
      transparent: !0,
      depthTest: !1,
      depthWrite: !1,
    }),
    f = new r(o, { geometry: s, program: d }),
    p = J.getBoundingClientRect();
  function m() {
    ((p = J.getBoundingClientRect()),
      !(p.width <= 0 || p.height <= 0) &&
        (a.setSize(p.width, p.height),
        (d.uniforms.uResolution.value[0] = p.width),
        (d.uniforms.uResolution.value[1] = p.height),
  ...
  (window.addEventListener(`resize`, m),
    ...
    typeof ResizeObserver < `u` && new ResizeObserver(m).observe(J),
    m());
  let h = { x: 0.5, y: 0.5, tx: 0.5, ty: 0.5 },
    g = { t: 0, target: 0 },
    _ = d.uniforms.uMouse.value,
    v = 0,
    y = 0;
  function b(e, t, n) {
    let r = v % 6,
      i = l[r];
    ((i[0] = e), (i[1] = t), (i[2] = 0), (u[r] = n), v++);
  }
  function x(e, t) {
    return [(e - p.left) / p.width, 1 - (t - p.top) / p.height];
  }
  (window.addEventListener(
    `pointermove`,
    (e) => {
      let [t, n] = x(e.clientX, e.clientY);
      ((h.tx = t), (h.ty = n));
      let r = t > -0.05 && t < 1.05 && n > -0.05 && n < 1.05;
      if (((g.target = +!!r), !r)) return;
      let i = performance.now();
      i - y > 180 && (b(t, n, 0.6), (y = i));
    },
    { passive: !0 },
  ),
    J.addEventListener(`pointerdown`, (e) => {
      let t = e.target;
      if (t && t.closest && t.closest(`a, button, iframe, .book-frame`)) return;
      let [n, r] = x(e.clientX, e.clientY);
      b(n, r, 1.6);
    }));
  let S = 0,
    C = !1,
    w = 0,
    T = !1,
    E = performance.now() - 7e3;
  new IntersectionObserver(
    (e) => {
      for (let t of e) C = t.isIntersecting && t.intersectionRatio > 0;
      C && !w && (w = requestAnimationFrame(k));
    },
    { threshold: [0, 0.05, 0.5], rootMargin: `10% 0%` },
  ).observe(J);
  let D = performance.now(),
    O = 0;
  function k(e) {
    if (((w = 0), e - O < ne - 1)) {
      C && (w = requestAnimationFrame(k));
      return;
    }
    O = e;
    let t = Math.min(0.066, Math.max(0.001, (e - D) / 1e3));
    if (
      ((D = e),
      (h.x += (h.tx - h.x) * 0.18),
      (h.y += (h.ty - h.y) * 0.18),
      (g.t += (g.target - g.t) * 0.08),
      K && e - S > 1700)
    ) {
      let t = (e - E) * 0.001;
      (b(
        0.5 + 0.32 * Math.sin(t * 0.4),
        0.5 + 0.18 * Math.sin(t * 0.61 + 1.3),
        0.8,
      ),
        (S = e));
    }
    ...
    for (let e = 0; e < 6; e++) {
      let r = l[e];
      r[2] >= 0 && ((r[2] += t), r[2] > 4.5 ? ((r[2] = -1), (u[e] = 0)) : n++);
    }
    ((_[0] = h.x),
      (_[1] = h.y),
      (d.uniforms.uHover.value = g.t),
      (d.uniforms.uTime.value = (e - E) * 0.001),
      a.render({ scene: f }),
      T ||
        ((T = !0),
        requestAnimationFrame(() => {
          J.classList.add(`webgl-on`);
        })));
    let r =
      n > 0 || Math.abs(g.target - g.t) > 0.005 || Math.abs(h.tx - h.x) > 0.002;
    (C || r) && (w = requestAnimationFrame(k));
  }
  w = requestAnimationFrame(k);
}
(function () {
  let e = window.matchMedia(`(prefers-reduced-motion: reduce)`).matches,
    n = document.documentElement.dataset.tier || `high`,
    r = n === `low` ? 1 : n === `mid` ? 1.25 : 1.5,
    i = document.getElementById(`site-drawer`),
    a = document.getElementById(`drawer-scrim`),
    o = document.getElementById(`drawer-content`),
    s = document.getElementById(`drawer-mask`),
    c = document.getElementById(`btn-menu`),
    l = document.getElementById(`drawer-close`);
  if (!i || !c || !s) return;
  let u = (e) => 1 - (1 - e) ** 4,
    d = {
      open: !1,
    ...
    f = `a[href], button:not([disabled]), [tabindex]:not([tabindex="-1"])`;
  function p(e) {
    if (!d.open || e.key !== `Tab`) return;
    let t = Array.from(o.querySelectorAll(f));
    if (!t.length) return;
    let n = t[0],
      r = t[t.length - 1];
      ...
      try {
        let {
          ...
          u = new e({
            canvas: s,
            alpha: !0,
            dpr: Math.min(window.devicePixelRatio, r),
            powerPreference: `high-performance`,
          }),
          f = u.gl;
        ...
        let p = l(u, {
          ...
          m = new a(f),
          h = () => +!!window.matchMedia(`(max-width: 768px)`).matches,
          g = new n(f, {
            vertex: `
          precision mediump float;
          attribute vec2 uv;
        ...
        `,
            uniforms: {
              uTime: { value: 0 },
              uProgress: { value: 0 },
              uWidth: { value: h() ? 1 : 0.65 },
              uHeight: { value: 1 },
              uMobile: { value: h() },
              uResolution: { value: [1, 1] },
              uMouse: { value: [0.5, 0.5] },
              uHover: { value: 0 },
              uGrainScale: { value: [0.5, 0.5] },
              uGrainTime: { value: 0 },
              uNoiseTex: { value: p },
            },
            transparent: !0,
          }),
          _ = new i(f, { geometry: m, program: g });
        u.autoClear = !1;
        let v = 1,
          y = 1;
        function b() {
          ...
          (u.setSize(e, t),
            (v = f.drawingBufferWidth),
            (y = f.drawingBufferHeight),
            (g.uniforms.uResolution.value[0] = e),
            (g.uniforms.uResolution.value[1] = t),
            (g.uniforms.uGrainScale.value[0] = e * 0.5),
            (g.uniforms.uGrainScale.value[1] = t * 0.5));
          let n = h();
          ((g.uniforms.uMobile.value = n),
            (g.uniforms.uWidth.value = n ? 1 : 0.65));
        }
        (b(),
          ...
          (d.program = g),
          (d.mesh = _));
        let x = g.uniforms.uMouse.value;
        function S() {
          (f.disable(f.SCISSOR_TEST), f.clear(f.COLOR_BUFFER_BIT));
          let e = d.progress;
          if (e <= 0.001) return;
          let t = g.uniforms.uWidth.value,
            n = e * e * (3 - 2 * e),
            r = Math.max(0, 1 - t * n - 0.06),
            i = Math.floor(r * v),
            a = Math.max(1, v - i);
        ...
        function C(e) {
          ((d.mx += (d.tmx - d.mx) * 0.16),
            (d.my += (d.tmy - d.my) * 0.16),
            (d.hover += (d.tHover - d.hover) * 0.09));
          let t = e * 0.001;
          ((g.uniforms.uTime.value = t),
            (g.uniforms.uGrainTime.value = t * 60),
            (g.uniforms.uProgress.value = d.progress),
            (x[0] = d.mx),
            (x[1] = d.my),
            (g.uniforms.uHover.value = d.hover * d.progress),
            S(),
            d.open || d.progress > 0.001 || d.hover > 0.001
              ? (d.tickHandle = requestAnimationFrame(C))
              : (f.disable(f.SCISSOR_TEST),
                f.clear(f.COLOR_BUFFER_BIT),
                (d.tickHandle = 0)));
        }
        ((d.renderWithScissor = S), (d.tickHandle = requestAnimationFrame(C)));
      } catch (e) {
        (console.warn(`[drawer] WebGL unavailable — using CSS fallback.`, e),
          (d.shaderFailed = !0),
          i.classList.add(`drawer--no-webgl`));
      }
    }
  }
  function g() {
    if (
      ...
      let { renderer: e, program: t, mesh: n, renderWithScissor: r } = d,
        i = t.uniforms.uMouse.value,
        a = (o) => {
          ((d.mx += (d.tmx - d.mx) * 0.16),
            (d.my += (d.tmy - d.my) * 0.16),
            (d.hover += (d.tHover - d.hover) * 0.09));
          let s = o * 0.001;
          ((t.uniforms.uTime.value = s),
            (t.uniforms.uGrainTime.value = s * 60),
            (t.uniforms.uProgress.value = d.progress),
            (i[0] = d.mx),
            (i[1] = d.my),
            (t.uniforms.uHover.value = d.hover * d.progress),
            r ? r() : e.render({ scene: n }),
            d.open || d.progress > 0.001 || d.hover > 0.001
              ? (d.tickHandle = requestAnimationFrame(a))
              : (d.tickHandle = 0));
        };
      d.tickHandle = requestAnimationFrame(a);
    }
  ...
  function _(e, t) {
    (cancelAnimationFrame(d.raf),
      (d.animFrom = d.progress),
      (d.animTo = e),
      (d.animStart = performance.now()),
      (d.animDur = t));
    let n = (e) => {
      let t = Math.min(1, (e - d.animStart) / d.animDur);
      ((d.progress = d.animFrom + (d.animTo - d.animFrom) * u(t)),
        t < 1
          ? (d.raf = requestAnimationFrame(n))
          : ((d.progress = d.animTo),
            (d.raf = 0),
            d.open ||
              (i.setAttribute(`aria-hidden`, `true`), (a.hidden = !0))));
    };
    d.raf = requestAnimationFrame(n);
  }
  function v() {
    d.open ||
      ((d.open = !0),
      (d.lastFocused = document.activeElement),
      (i.dataset.open = `true`),
      ...
      e ? (d.progress = 1) : (h().then(g), _(1, 620), g()),
      setTimeout(
        () => {
          let e = o.querySelector(f);
  ...
  function y() {
    d.open &&
      ...
      e
        ...
        : (_(0, 520), g()),
      d.lastFocused &&
        typeof d.lastFocused.focus == `function` &&
        d.lastFocused.focus({ preventScroll: !0 }));
  }
  (c.addEventListener(`click`, () => {
    ...
    o.addEventListener(`click`, (e) => {
      ...
      if (!t) return;
      let n = t.getAttribute(`href`);
      !n || n === `#` || (document.querySelector(n) && y());
    }));
  function b(e) {
    let t = window.innerWidth,
      n = window.innerHeight;
    ((d.tmx = Math.max(0, Math.min(1, e.clientX / Math.max(t, 1)))),
      (d.tmy = 1 - Math.max(0, Math.min(1, e.clientY / Math.max(n, 1)))));
  }
  if (
    (i.addEventListener(`pointermove`, b, { passive: !0 }),
    ...
    let e = () => {
      let e = () => {
        d.shaderInit ||
          h()
            .then(() => {
              if (!d.program || !d.renderer || !d.mesh) return;
              let e = d.renderer.gl;
              ((d.program.uniforms.uProgress.value = 0.5),
                (d.program.uniforms.uHover.value = 0.5),
                (d.program.uniforms.uTime.value = 0),
                (d.program.uniforms.uGrainTime.value = 0),
                (d.program.uniforms.uMouse.value[0] = 0.5),
                (d.program.uniforms.uMouse.value[1] = 0.5),
                e.disable(e.SCISSOR_TEST),
                e.clear(e.COLOR_BUFFER_BIT),
                d.renderer.render({ scene: d.mesh }),
                d.renderer.render({ scene: d.mesh }),
                e.finish(),
                (d.program.uniforms.uProgress.value = 0),
                (d.program.uniforms.uHover.value = 0),
                e.clear(e.COLOR_BUFFER_BIT));
            })
            .catch(() => {});
      };
    ...
    (window.addEventListener(`preloader:done`, e, { once: !0 }),
      setTimeout(() => {
        d.shaderInit || e();
      }, 3e3));
  }
...
async function ie(e, n) {
  let [{ gsap: r }, { ScrollTrigger: i }] = await Promise.all([
    t(
      () => import(`./gsap-C_F2famk.js`),
      __vite__mapDeps([2, 3]),
      import.meta.url,
  ...
  r.registerPlugin(i);
  let { swordGroup: a, targetRef: o } = n,
    s = r.quickTo(a.position, `x`, { duration: 0.6, ease: `power3.out` }),
    c = r.quickTo(a.position, `y`, { duration: 0.6, ease: `power3.out` }),
    l = r.quickTo(a.position, `z`, { duration: 0.6, ease: `power3.out` }),
    u = r.quickTo(a.rotation, `x`, { duration: 0.6, ease: `power3.out` }),
    d = r.quickTo(a.rotation, `y`, { duration: 0.6, ease: `power3.out` }),
    f = r.quickTo(a.rotation, `z`, { duration: 0.6, ease: `power3.out` });
  n.setEaser(() => {
    (s(o.x), c(o.y), l(o.z), u(o.rx), d(o.ry), f(o.rz));
  });
  function p(e) {
    let t = 0.18 * m(0, 0.5, e),
      n = 0.55 * Math.exp(-(((e - 0.5) / 0.06) ** 2)),
      r = 0.22 * m(0.5, 0.62, e) * (1 - m(0.9, 1, e));
    return Math.min(1, t + n + r);
  }
  function m(e, t, n) {
    let r = Math.max(0, Math.min(1, (n - e) / (t - e)));
    return r * r * (3 - 2 * r);
  ...
  i.create({
    ...
    scrub: !0,
    onUpdate: (e) => {
      (n.setProgress(e.progress), n.setShake(p(e.progress)));
    },
  });
  let h = e.querySelector(`.samurai-marquee`),
    g = [
      { el: e.querySelector(`.samurai-row--top`), drift: -260 },
      { el: e.querySelector(`.samurai-row--mid`), drift: 380 },
      { el: e.querySelector(`.samurai-row--bot`), drift: -560 },
    ].filter((e) => e.el),
    _ = (e) => -(e.scrollWidth - window.innerWidth) / 2;
  if (
    (g.forEach(({ el: t, drift: n }) => {
      (r.set(t, { x: _(t), opacity: 0, y: 60 }),
        r.to(t, {
          x: _(t) + n,
          ease: `none`,
          scrollTrigger: {
    ...
    g.length &&
      r.to(
        ...
        {
          opacity: (e, t) =>
            t.classList.contains(`samurai-row--bot`) ? 0.55 : 1,
          y: 0,
          duration: 1.4,
          ease: `power3.out`,
          stagger: 0.18,
    ...
    let t = r.quickTo(h, `skewY`, { duration: 0.55, ease: `power3.out` });
    i.create({
      trigger: e,
      start: `top bottom`,
      end: `bottom top`,
      onUpdate: (e) => {
        let n = e.getVelocity();
        t(Math.max(-6, Math.min(6, n / -250)));
      },
    });
  }
  let v = e.querySelectorAll(`.samurai-quote__line`),
    y = e.querySelector(`.samurai-quote__attr`);
  if (v.length) {
    let t = e.querySelectorAll(
      `.samurai-quote__line .k-line-inner, .samurai-quote__attr .k-line-inner`,
    );
    r.set(t, { yPercent: 110 });
    let n = r.timeline({
        scrollTrigger: {
          trigger: e,
          start: `top top`,
    ...
    if (
      (v.forEach((e, t) => {
        let r = i[t];
        if (!r) return;
        let a = e.querySelector(`.k-line-inner`);
        if (!a) return;
        let o = t === v.length - 1;
        (n.to(a, { yPercent: 0, duration: 0.06, ease: `power3.out` }, r.in),
          o ||
            n.to(
              a,
              { yPercent: -110, duration: 0.05, ease: `power3.in` },
              r.out - 0.05,
            ));
      }),
      y)
    ) {
      let e = y.querySelector(`.k-line-inner`);
      e && n.to(e, { yPercent: 0, duration: 0.06, ease: `power3.out` }, 0.92);
    }
    n.to({}, { duration: 0.001 }, 1);
  }
  console.log(`[samurai] motion wired`);
}
var Q = (e, t) => {
  let n = `[samurai] ${e}` + (t ? ` ` + JSON.stringify(t) : ``);
  (console.log(n),
    (window.__samurai = window.__samurai || { log: [] }),
    window.__samurai.log.push({
      t: performance.now().toFixed(0),
      msg: e,
      extra: t,
    }));
};
Q(`entry-stub running`);
var $ = document.getElementById(`samurai-slash`);
if (
  ((window.__samurai = { ...(window.__samurai || {}), section: !!$ }),
  Q(`section found`, { found: !!$ }),
  $)
) {
  let e = matchMedia(`(prefers-reduced-motion: reduce)`).matches,
    n = document.documentElement.dataset.tier || `high`;
  if ((Q(`flags`, { reduceMotion: e, tier: n }), !e && n !== `low`)) {
    let e = $.querySelector(`.samurai-stick`);
    if ((Q(`stick found`, { found: !!e }), e)) {
      let r = document.createElement(`canvas`);
      ((r.className = `samurai-stage`),
        r.setAttribute(`aria-hidden`, `true`),
        e.insertBefore(r, e.firstChild),
        Q(`canvas injected`, { cssW: r.clientWidth, cssH: r.clientHeight }),
        (window.__samurai.canvas = r));
      let i = null,
        a = new IntersectionObserver(
          async (e) => {
            let o = e.some((e) => e.isIntersecting);
            if (
              (Q(`ioLoad fired`, {
                visible: o,
              ...
              (a.disconnect(), Q(`lazy import starting`));
              try {
                let e = await t(
                  () => import(`./scene-CodDTYkg.js`),
                  [],
                  import.meta.url,
                );
                (Q(`lazy import resolved`, {
                  hasCreateScene: typeof e.createScene,
                }),
                  (i = await e.createScene({
                    canvas: r,
                    tier: n,
                    swordUrl: `../assets/mina-samo.glb`,
                  })),
                  (window.__samurai.sceneApi = i),
                  await ie($, i),
                  new URLSearchParams(location.search).has(`tweak`) &&
                    ((
                      await t(
                        () => import(`./tweak-panel-BKq0Qcdp.js`),
                        [],
                        import.meta.url,
                      )
                    ).mountTweakPanel(i.tweak),
                    Q(`tweak panel mounted`)),
                  Q(`scene created`, {
                    cssW: r.clientWidth,
                    cssH: r.clientHeight,
                    internalW: r.width,
                  ...
                  new IntersectionObserver(
                    (e) => {
                      ...
                      (Q(`ioRun toggle`, { active: t }), i?.setActive(t));
                    },
                    { threshold: 0 },
                  ).observe($));
              } catch (e) {
                (Q(`scene init FAILED`, { error: String(e), stack: e?.stack }),
                  r.remove());
              }
            }
          },
          { rootMargin: `200% 0%`, threshold: 0 },
        );
      (a.observe($), Q(`ioLoad observing`));
    }
  } else Q(`skipped (reduced-motion or low tier)`);
}
